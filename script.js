...
const gameOver = (isVictory) => {
    ...
    setTimeout(() => {
        const modalText = isVictory ? `You found the word:` : `Game Over! The correct word is:`;
...
const initGame = (button, clickedLetter) => {
    ...
    if(currentWord.includes(clickedLetter)) {
        // Displaying the letter if it is in the word
        ...
        // If clicked letter doesn't exist then update the wrongGuessCount and hangmans image
        wrongGuessCount++;
        hangmanImage.src = `hangman-${wrongGuessCount}.svg`;
    }
    ...
    // Calling gameOver function if any of these codition meets
